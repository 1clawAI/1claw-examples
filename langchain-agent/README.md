...
- Connect LangChain to the hosted 1Claw MCP server (all 27+ tools, zero config)
...
| `src/mcp-client.ts` | Connects to the hosted 1Claw MCP server — all 27+ tools loaded automatically | OpenAI only |
