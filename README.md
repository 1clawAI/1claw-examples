...
Example applications demonstrating the [1Claw](https://1claw.xyz) SDK and API.

## Examples

| Example                                       | Description                                                                                              |
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| [basic](./basic/)                             | TypeScript scripts: vault CRUD, secrets, billing, signup, email sharing, and crypto transaction proxy    |
