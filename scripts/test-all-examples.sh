...
echo "=============================================="
echo " 1Claw examples — test all (22)"
echo "=============================================="
echo ""

# --- 1. local-inspect (no credentials needed) ---
echo "[1/22] local-inspect"
